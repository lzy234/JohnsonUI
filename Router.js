...
class AppRouter {
    ...
    getBasePath() {
        ...
        // 使用window.location.origin获取基础URL
        const origin = window.location.origin;
        
        // 如果当前在子目录中，计算相对于根目录的路径
        if (currentPath.includes('/index/') || 
            ...
            if (basePath.includes('/index/')) {
                basePath = basePath.substring(0, basePath.indexOf('/index/'));
            } else if (basePath.includes('/upload/')) {
                basePath = basePath.substring(0, basePath.indexOf('/upload/'));
            } else if (basePath.includes('/analysis/')) {
                basePath = basePath.substring(0, basePath.indexOf('/analysis/'));
            } else if (basePath.includes('/ai/')) {
                basePath = basePath.substring(0, basePath.indexOf('/ai/'));
            }
